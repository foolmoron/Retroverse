...
{
    public class SandPickup : Powerup
    {
        public SandPickup(Hero hero)
            : base(hero)
        {
            ...
            Icon = TextureManager.Get("sandicon"); //filename for this powerup's icon
            DrawBeforeHero = true; //should the powerup's effects be drawn before the sprite of the hero, or above? 
            TintColor = Color.SaddleBrown; //what color should this powerup's icon and related effects be?
            Description = "+1 Sand"; //give a short description (with appropriate newlines) of the powerup, for display to the player
        }
